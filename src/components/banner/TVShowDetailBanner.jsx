...
const TVShowDetailBanner = ({ setShowModal, tvShowDetail }) => {
  ...
  const certification = tvShowDetail.release_dates?.results
...
TVShowDetailBanner.propTypes = {
  setShowModal: PropTypes.func,
  tvShowDetail: PropTypes.object
}
export default TVShowDetailBanner